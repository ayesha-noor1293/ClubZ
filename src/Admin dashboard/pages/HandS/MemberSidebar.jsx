...
import { Link } from 'react-router-dom';
 ...
 <Link to='/RequestsPage' className='AD-item'><MdOutlinePendingActions  className='icon'/> Requests List</Link>
 <Link to='/MembersPage' className='AD-item active'><IoDocumentTextOutline className='icon'/> Members Data</Link>
